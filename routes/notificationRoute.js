...
//   });
  ...
  // router.get('/email/notifications', (req, res) => {
  //   const managerid = req.query.managerid;
  //   const query = "SELECT * FROM notifications WHERE email = 'admin@funstay.in' AND `read` = 0 ORDER BY createdAt DESC";
  ...
  router.get('/email/notifications', (req, res) => {
    const managerid = req.query.managerid;
    const query = "SELECT * FROM notifications WHERE email = 'admin' AND `read` = 0 ORDER BY createdAt DESC";
